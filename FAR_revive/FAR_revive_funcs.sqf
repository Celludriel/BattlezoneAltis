...
FAR_Player_Actions =
{
	diag_log format ["Calling FAR_Player_Actions"];
	if (alive player && player isKindOf "Man") then
	{
		...
		player addAction ["<t color=""#C90000"">" + "Respawn" + "</t>", "FAR_revive\FAR_handleAction.sqf", ["action_suicide"], 9, false, true, "", "call FAR_Check_Suicide"];
