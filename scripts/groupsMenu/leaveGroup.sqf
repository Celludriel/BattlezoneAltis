diag_log format ["Calling leaveGroup.sqf with: %1", _this];
...
GRPMNU_groupActions = _caller addAction["<t color='#DF01D7'>Groups Menu</t>", "scripts\groupsMenu\groupActions.sqf", nil, -200, false, false, "", "_target == vehicle _this || _target == _this"];
